import{i as D,k as y,a2 as I,p as _,a3 as v,a4 as R,F as L,_ as x,C as U,r as E,a5 as F}from"./firebase-CoJABIE_.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Z="auth-internal",ee="app-check-internal",te="messaging-internal";function ne(e){const t=(n,{instanceIdentifier:r})=>{const i=n.getProvider("app").getImmediate(),o=n.getProvider(Z),a=n.getProvider(te),s=n.getProvider(ee);return new q(i,o,a,s,r)};x(new U(w,t,"PUBLIC").setMultipleInstances(!0)),E(C,b,e),E(C,b,"esm2020")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
